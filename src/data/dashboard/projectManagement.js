...
export const runningProjects = [
  ...
  },
  {
    ...
    avatar: {
      name: 'U',
      size: 'xl',
      contentClass: 'text-success bg-success-subtle fs-0'
    },
  ...
  },
  {
    ...
    avatar: {
      name: 'F',
      size: 'xl',
      contentClass: 'text-info bg-info-subtle fs-0'
    },
  ...
  },
  {
    ...
    avatar: {
      name: 'D',
      size: 'xl',
      contentClass: 'text-warning bg-warning-subtle fs-0'
    },
    projectName: 'Themewagon',
    members: [
      {
  ...
  },
  {
    ...
    avatar: {
      name: 'S',
      size: 'xl',
      contentClass: 'text-danger bg-danger-subtle fs-0'
    },
