...
const ViewRutasCard = ({reservas, movimientos, estatus, layout, setFilter, situaciones, usuarios}) => {
  ...
  const { selectedItems, isSelectedItem, toggleSelectedItem } = useBulkSelect(reservaIds);
