...
const AllPasajerosHeader = ({
    ...
    const handleNuevoClick = () => {
        navigate("/Catalogos/Pasajeros/0");
    };
    return (
        <div className='d-lg-flex justify-content-between'>
            <Row className='flex-between-center gy-2 px-x1'>
                <Col xs='auto' className='pe-0'>
                    <h6 className='mb-0'>Pasajeros</h6>
                </Col>
                <Col xs='auto'>
                    {layout === 'view-table'? (
                        ...
                        <Dropdown.Menu className="border py-0">
                          <div className="py-2">
                            ...
                            <Link
                              ...
                              onClick={() => console.log("Navigating to Pasajeros-card with state:", { formView: 'view-card' })}
                            >
                              Vista Tarjeta
                            </Link>
                          </div>
...
export default AllPasajerosHeader;