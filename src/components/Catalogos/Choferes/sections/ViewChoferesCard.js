...
import AllChoferesHeader from '../tables/AllChoferesHeader';
import { active } from 'd3';
import ChoferesFilterForm from './ChoferesFilterForm';
import { CardChoferesLayout } from './CardChoferesLayout';
...
const ViewChoferesCard = ({choferes, estatus, empresa, sucursal, layout, setFilter, }) => {
    ...
    const choferesIds = choferes.data.map(chofer => chofer.id);
    const { selectedItems, isSelectedItem, toggleSelectedItem } = useBulkSelect(choferesIds);
    const [allChoferes] = useState(choferes.data.slice(0, 21));
        ...
        <Row className='gx-3'>
            ...
            <Col xxl={2} xl={3}>
                ...
                >
                    ...
                    <ChoferesFilterForm estatus={estatus} sucursal={sucursal} empresa={empresa} setFilter={setFilter} />
                </Offcanvas>
            </Col>
        </Row>
    );
