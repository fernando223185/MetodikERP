...
export const CardChoferesLayout = ({ data, isSelectedItem, toggleSelectedItem }) => {
            ...
            <div className="d-flex align-items-start align-items-sm-center">
              ...
              <div className="ms-1 ms-sm-3">
                <p className="fw-semi-bold mb-3 mb-sm-2">
                  <Link to={`/catalogo/choferes/view-profile/${chofer.ID}`}>{chofer.Nombre}</Link>
                </p>
