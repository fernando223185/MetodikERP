...
const RutasFilterForm = ({ estatus, sucursal, setFilter, filter }) => {
    ...
    const handleSearch = () => {
        const data = {
            EstatusID: selectedEstatus ? selectedEstatus : null,
            SucursalID: selectedSucursal ? selectedSucursal : null
        };
