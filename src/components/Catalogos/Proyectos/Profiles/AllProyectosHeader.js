...
const AllProyectosHeader = ({
    ...
    const handleNuevoClick = () => {
      navigate("/catalogos/proyectos/0");
    };
    ...
    return(
      <div className='d-lg-flex justify-content-between'>
          <Row className='flex-between-center gy-2 px-x1'>
              ...
              <h6 className='mb-0'>Proyectos</h6>
              </Col>
              <Col xs='auto'>
              {layout === 'view-table'? (
                      ...
                      <Dropdown.Menu className="border py-0">
                        <div className="py-2">
                          ...
                          <Link
                            ...
                            onClick={() => console.log("Navigating to Vehiculos-card with state:", { formView: 'view-card' })}
                          >
                            Vista Tarjeta
                          </Link>
                        </div>
  ...
  export default AllProyectosHeader;