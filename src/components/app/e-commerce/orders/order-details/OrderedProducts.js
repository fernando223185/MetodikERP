        ...
        <div className="table-responsive fs--1">
          <Table striped className="border-bottom">
            <thead className="bg-200">
              <tr>
                <th className="text-900 border-0">Products</th>
                <th className="text-900 border-0 text-center">Quantity</th>
                <th className="text-900 border-0 text-end">Rate</th>
                <th className="text-900 border-0 text-end">Amount</th>
              </tr>
            </thead>
            <tbody>
