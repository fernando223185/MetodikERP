...
function Example() {
  ...
  return (
    <div className='bg-dark p-3'>
      <Toast show={show} onClose={() => setShow(!show)}>
        <Toast.Header className="text-bg-body-tertiary">
          <strong className="me-auto">Bootstrap</strong>
          <small>11 mins ago</small>
        </Toast.Header>
        <Toast.Body className="text-bg-body-tertiary">Hello, world! This is a toast message.</Toast.Body>
      </Toast>
    </div>
  );
}`;
...
const Toasts = () => (
  <>
    ...
    >
      <Button
        href={`${reactBootstrapDocsUrl}/docs/components/toasts`}
        target="_blank"
        variant="link"
        size="sm"
        className="ps-0"
